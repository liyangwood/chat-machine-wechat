...
//        path : rootPath+'/temp/weixinlogimage',
...
(function(){
    ...
    var wx = {
        ...
        saveImage : function(name, buffer, callback){
            ...
            var path = process.env.PWD+'/temp/weixinlogimage/'+name+'.png';

            var fn = Meteor.wrapAsync(function(callback){
            ...
            //
            //        Images.insert(newFile, callback);
            //    }));
            //});
            //
            //fn(callback);
        ...
        getMessageImage : function(id, callback){
            ...
            request(F.setOption({
                ...
                var save = (wx.saveImage);
                save(id, body, function(e, file){
                    console.log(file);
                    _.delay(function(){
                        console.log(e, file);
        ...
        getTestImage : function(id, callback){
            ...
            id = id || 'd';
            var url = 'http://qun.haiwai.com/image/haiwai.png';
