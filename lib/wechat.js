...
(function(){
    ...
    var wx = {
        ...
        getMessageImage : function(id, callback){
            ...
            var fileName = '/public/weixinlogimage/'+id+'.png';
        ...
        getTestImage : function(id, callback){
            ...
            //var meteorRequest = Meteor.wrapAsync(request);
            //
            //meteorRequest(F.setOption({
            //    url : url
            //}), function(err, res, body){
            //
            //    var newFile = new FS.File();
            ...
            //        if(error) throw error;
            //        console(newFile);
            //        newFile.name('aaa.png');
            //
            //        Images.insert(newFile);
            //    });
            //});

            //Images.insert(url, function(err, rs){
            //    console.log(err, rs);
            //});
